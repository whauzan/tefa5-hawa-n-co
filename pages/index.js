import { Blog, Card, HeroBanner } from "../components";
...
export default function Home({ products, banners }) {
  return (
    <div>
      ...
      <div className="flex flex-col items-center justify-center gap-y-2 text-brown-dark text-center mt-10">
        <h2 className="text-4xl font-Lora font-extrabold">Jewellery Blog</h2>
        <p className="mb-8">Ketahui lebih banyak tentang perhiasan</p>
        <div className="row-2 flex flex-wrap justify-center">
          <Blog
            img={
              "https://www.passionjewelry.co.id/uploads/cara-membersihkan-cincin-berlian-yang-aman-dan-benar-4690-2020-04-21-145403.peg"
            }
            url={
              "https://www.passionjewelry.co.id/news-detail/cara-membersihkan-cincin-berlian-yang-aman-dan-benar"
            }
          ...
          <Blog
            img={
              "https://www.passionjewelry.co.id/uploads/langkah-tepat-memilih-berlian-524-2020-04-08-170713.jpg"
            }
            url={
              "https://www.passionjewelry.co.id/news-detail/langkah-tepat-memilih-berlian"
            }
